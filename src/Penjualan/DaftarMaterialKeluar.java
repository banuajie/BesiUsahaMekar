 ...
 * @author Banuajie
 */
public class DaftarMaterialKeluar extends javax.swing.JInternalFrame {
public DefaultTableModel tabModel;
Connection conn;
    /**
     * Creates new form DaftarMaterialKeluar
     */
    public DaftarMaterialKeluar() {
        initComponents();
        setJTable();
        jmldatatable();
    }
    ...
    private void getDataitemmasuk() {
        // import java.sql.connection
           ...
           try{
            ...
            String sql="Select * from tmaterialkeluar where Status = '1'";
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Data Material Keluar", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 3, 12), java.awt.Color.black)); // NOI18N
