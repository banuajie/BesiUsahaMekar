 ...
 public String getretur() {
    ...
    if (ok == 0) {
      try {
        ...
        String sql ="update ttemppesananjual set Nama = ?, Jumlah= ?, Harga= ?, Total= ? WHERE Kode_Item = ? ";
    ...
    if (ok == 0) {
      try {
        conn=koneksidb.getkoneksi();
        String sql ="update ttemptransaksijual set Nama = ?, Jumlah= ?, Harga= ?, Total= ? WHERE Kode_Item = ? and No_Transaksi = ?";
        PreparedStatement p=(PreparedStatement) conn.prepareStatement(sql);
    ...
    public void rubahDataitemkeluar() {
    ...
    if (ok == 0) {
      try {
        conn=koneksidb.getkoneksi();
        String sql ="update ttempmaterialkeluar set Nama = ?, Jumlah= ?, Harga= ?, Total= ? WHERE Kode_Item = ? and No_Transaksi = ?";
        PreparedStatement p=(PreparedStatement) conn.prepareStatement(sql);
     ...
     public void rubahDataretur() {
      ...
      try {
        conn=koneksidb.getkoneksi();
        String sql ="update ttempreturjual set Jumlah= ? , Total=? WHERE No_Retur = ? and Kode_Item = ?";
        PreparedStatement p=(PreparedStatement) conn.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Data Material", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 12))); // NOI18N
